...
## Contents
- `TruthOracle`: external semantic authority
- `InternalizesOracle`: what it means to internalize an oracle
- `oracle_not_internalizable`: Truth cannot be internalized (via T2)
- `oracle_authority_is_gap`: oracle stricty extends Provable
-/
